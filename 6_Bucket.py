...
with gp.Env() as env, gp.Model(env=env) as model:
    ...
    R = model.addVar(lb=0.0, vtype=GRB.CONTINUOUS, name="R")
    h = model.addVar(lb=0.0, vtype=GRB.CONTINUOUS, name="h")

    # Autoriser les expressions non convexes (obligatoire pour sqrt, produits, etc.)
    ...
    model.addConstr(A_bot + A_lat == 1, name="surface")
